            ...
            <View className='flex-1 bg-white'>
                ...
                <View className='p-5'>
                    ...
                    <ReactNativeModal
                        ...
                        onModalHide={() =>
                            verification.state === 'success' ? setShowSuccessModal(true) : setShowSuccessModal(false)
                        }
                    >
                        <View className='bg-white px-7 py-9 rounded-2xl min-h[300px]'>
                            <Text className='text-2xl font-JakartaExtraBold mb-2'>Verification</Text>
                            <Text className='font-Jakarta mb-5'>We've sent a verification email to {form.email}</Text>
                            <InputField
                                label='Code'
                                icon={icons.lock}
                                placeholder='12345'
